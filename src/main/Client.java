...
public class Client {
	...
	public Client(Address mainServerAddress, String objectName) throws RemoteException, NotBoundException {
	...
	public FileContent read(String fileName) throws FileNotFoundException, RemoteException, IOException, NotBoundException {
	...
	public void write(String fileName, ArrayList<FileContent> data) throws FileNotFoundException, RemoteException, IOException, NotBoundException, MessageNotFoundException {
		// get the address of primary replicated server
